use {
    ...
    winit::{
        dpi::{LogicalPosition, Position}, event::{DeviceEvent, Event, MouseScrollDelta, WindowEvent}, event_loop::{ControlFlow, EventLoop}, window::{Window, WindowBuilder}
    },
};
        ...
        match event {
            ...
            Event::DeviceEvent { event, .. } => match event {
                ...
                DeviceEvent::MouseMotion { delta } => {
                    ...
                    window.set_cursor_position(LogicalPosition::new(0.0, 0.0)).unwrap();
                },
                _ => (),
            },
            _ => (),
